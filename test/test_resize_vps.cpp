...
int main() {
  ...
  {
    RCLCPP_INFO(rclcpp::get_logger("example"), "%s", "Test hobotcv_resize: Mat Input, VPS Process");
    ...
    if (0 == ret) {
      ...
      // 保存结果
      writeImg(dstmat_nv12, "./resize_mat_input_vps_process.jpg");
    }
  }
  ...
  // 5.缩放图像、测试耗时，输入图像为数组格式
  {
    ...
    if (imageInfo != nullptr) {
      ...
      writeImg(dst_mat, "./resize_arr_input_vps_process.jpg");
    }
  }
